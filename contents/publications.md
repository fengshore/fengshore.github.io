...
- <strong>Qiufeng Wang</strong>&ast;, <strong>Jiaxuan Zhu</strong>&ast;, <strong>Ziteng Feng</strong>&ast;, <strong>Zhenyu Cui</strong>&ast;, <strong>Jialong Wu</strong>&ast;, <strong>Shuxia Lin</strong>&ast;, <strong>Caorui Li</strong>&ast;, Renzhao Liang, Yifei Yu, Kun Wang, Qiankun Li, Guibin Zhang, Siming Huang, Xianzhen Luo, Jie Wang, Junnan Dong, Siyu An, Biao Liu, Yidong Wang,Zhongxiang Sun, DengBao Wang, Xu Yang, Yang Liu, MinLing Zhang, di yin, Xing Sun, Jiaheng Liu, QianWen Zhang. Memoria-Bench: A Comprehensive Benchmark for Evaluating Memory in Long-Horizon Autonomous Agents. Accepted by ICML 2026(CCF-A)

- Puhua Chen, Yang Liu, Fang Liu, Xiangrong Zhang, Ziteng Feng, Licheng Jiao. Multi-perspective Visual Feature Enhancement and Interaction for Remote Sensing Image Captioning. Accepted by JSTARS(中科院二区Top) [<i class="bi bi-file-earmark-text"></i> IEEE](https://ieeexplore.ieee.org/abstract/document/11494245)
